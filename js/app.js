define([
  ...
  function(viewport, log) {
    ...
    function setupNav() {
      ...
      var headerTemplate = _.template('<li class="nav-header"><%= heading %></li>'),
      ...
      function setupNavAnchor(container, anchor) {
        var title = anchor.data("nav-anchor"),
            slug = slugify(title),
        ...
        anchor.attr('id', slug);
        container.append(anchorTemplate( {title: title, slug: slug}));
      }
