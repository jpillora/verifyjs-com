(function(e) {
  ...
  var t = e.Object,
    n = e.Array,
    r = function() {
      if (typeof n.isArray === "function") {
        return n.isArray
      }
      return function(e) {
        return t.prototype.toString.call(e) === "[object Array]"
      }
    }();
  i.prototype.addListener = function(e, t, n) {
    ...
    if (r[e].length + 1 > this.maxListeners && this.maxListeners !== 0) {
  ...
  i.prototype.listeners = function(e) {
    ...
    if (this.collection[e] === undefined) {
  ...
  i.prototype.emit = function() {
    ...
    if (r(this.collection[t.type])) {
      n = this.collection[t.type];
      i = 0;
      s = n.length;
      for (i; i < s; i += 1) {
